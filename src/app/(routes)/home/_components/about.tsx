        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-12 px-6 py-16 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="h-64 w-64 rounded-full border border-yellow-400/80 bg-gradient-to-br from-yellow-500 to-transparent p-4 shadow-2xl md:h-72 md:w-72">
              ...
              <div className="absolute inset-x-0 -bottom-8 mx-auto flex w-full max-w-xs justify-between gap-3 text-sm">
