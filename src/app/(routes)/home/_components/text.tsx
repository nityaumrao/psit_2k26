    ...
    <div className="relative w-full h-screen overflow-hidden">
      <div className="absolute inset-0 flex flex-col justify-between pb-0 px-6 py-6 text-white">
        <header className="flex items-start justify-between text-[10px] uppercase tracking-[0.4em]">
          ...
          <div className="hidden lg:flex flex-col pl-30  text-left w-[80%] md:w-[60%] lg:w-[40%] mx-auto gap-6">
            <div className="flex gap-10 text-[9px] tracking-[0.3em]">
              <div className="flex flex-col items-start gap-1">
                ...
                <span className="text-[11px] uppercase tracking-[0.2em] text-white underline decoration-white/50">
                  View All
                </span>
              </div>
              <div className="flex flex-col items-start gap-1">
                <span className="text-[9px] tracking-[0.45em]">Get in touch</span>
                <span className="text-[11px] uppercase tracking-[0.2em]">info@goodnight.co.uk</span>
        ...
        <div className=" pl-30  text-left w-[80%] md:w-[60%] lg:w-[40%] mx-auto">
          <p className="text-white text-[18px] md:text-[24px] lg:text-[32px] font-semibold tracking-[0.2em]">
